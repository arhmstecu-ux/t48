...
type TableName = 'products' | 'purchases' | 'purchase_items' | 'replay_videos' | 'announcements' | 'reviews' | 'app_settings' | 'profiles' | 'chat_messages' | 'group_messages' | 'group_members' | 'vouchers' | 'voucher_usage' | 'spin_prizes' | 'spin_results' | 'user_spins';
